        ...
        **************************/
        try {
          ...
          subdevices.forEach(subdevice => {
            ...
            if (!(accessory.control instanceof deviceLink)) {
              accessory.control = new deviceLink(this, accessory, device, subdevice)
            }
            this.devicesInHB.set(uuid, accessory)
            this.log('[%s] found with serial number [%s] and mac address [%s].', accessory.displayName, device.serialNumber, device.macAddress)
        ...
        if (device.deviceType === helpers.deviceTypes.Insight) {
          ...
          WEMO INSIGHT
          ***********/
          if (!(accessory.control instanceof deviceInsight)) {
          ...
          WEMO LIGHT DIMMER
          ****************/
          if (!(accessory.control instanceof deviceLightDimmer)) {
          ...
          WEMO LIGHT SWITCH
          ****************/
          if (!(accessory.control instanceof deviceLightSwitch)) {
          ...
          *********/
          const usage = helpers.hasProperty(this.makerTypes, device.serialNumber)
            ...
            : 'switch'
          if (usage === 'switch') {
            if (!(accessory.control instanceof deviceMakerSwitch)) {
              accessory.control = new deviceMakerSwitch(this, accessory, device)
            }
          } else {
            if (!(accessory.control instanceof deviceMakerGarage)) {
              accessory.control = new deviceMakerGarage(this, accessory, device)
            }
          }
          ...
          WEMO MOTION SENSOR
          *****************/
          if (!(accessory.control instanceof deviceMotion)) {
          ...
          WEMO OUTLET
          **********/
          if (!(accessory.control instanceof deviceOutlet)) {
            accessory.control = new deviceOutlet(this, accessory, device)
          }
        } else if (device.deviceType === helpers.deviceTypes.HeaterA) {
          /**********
          WEMO HEATER
          **********/
          if (!(accessory.control instanceof deviceHeater)) {
