...
module.exports = {
  ...
  allowed: {
    wemoInsights: ['serialNumber', 'showTodayTC', 'wattDiff', 'overrideDisabledLogging'],
    wemoLights: ['serialNumber', 'adaptiveLightingShift', 'brightnessStep', 'overrideDisabledLogging'],
    wemoMakers: ['serialNumber', 'makerType', 'makerTimer', 'overrideDisabledLogging'],
    wemoMotions: ['serialNumber', 'noMotionTimer', 'overrideDisabledLogging'],
    wemoOthers: ['serialNumber', 'overrideDisabledLogging'],
    wemoOutlets: ['serialNumber', 'showAsSwitch', 'overrideDisabledLogging']
  },
