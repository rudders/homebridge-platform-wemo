...
class WemoPlatform {
              ...
              for (const [k, v] of Object.entries(x)) {
                switch (k) {
                  ...
                  case 'overrideDisabledLogging':
                    ...
                    this.wemoMakers[sn][k] = v === 'false' ? false : !!v
                    break
                  case 'serialNumber':
                    break
                  default:
              ...
              for (const [k, v] of Object.entries(x)) {
                switch (k) {
                  ...
                  case 'brightnessStep': {
                    ...
                    if (isNaN(intVal)) {
                      logDefault(key + '.' + k, this.consts.defaultValues[k])
                      this.wemoLights[sn][k] = this.consts.defaultValues[k]
                    } else if (intVal < this.consts.minValues[k]) {
                      logIncrease(key + '.' + k, this.consts.minValues[k])
                      this.wemoLights[sn][k] = this.consts.minValues[k]
                    } else {
                      this.wemoLights[sn][k] = intVal
                    }
                    break
                  }
                  case 'overrideDisabledLogging':
                    ...
                    this.wemoLights[sn][k] = v === 'false' ? false : !!v
                    break
                  case 'serialNumber':
                    break
                  default:
              ...
              for (const [k, v] of Object.entries(x)) {
                switch (k) {
                  case 'overrideDisabledLogging':
                    ...
                    this.wemoMotions[sn][k] = v === 'false' ? false : !!v
                    break
                  case 'noMotionTimer': {
                    if (typeof v === 'string') {
                      logQuotes(key + '.' + k)
              ...
              for (const [k, v] of Object.entries(x)) {
                switch (k) {
                  case 'overrideDisabledLogging':
                    ...
                    this.wemoOthers[sn][k] = v === 'false' ? false : !!v
                    break
                  case 'serialNumber':
                    break
                  default:
  ...
  async loadDevice (setupUrl) {
    ...
    try {
      ...
      const res = await this.axios.get(setupUrl, { timeout: 10000 })
