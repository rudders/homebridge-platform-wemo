    ...
    try {
      ...
      switch (device.deviceType) {
        ...
        case 'urn:Belkin:device:insight:1': {
          // Wemo Insight
          if (
            this.wemoInsights[device.serialNumber] &&
            this.wemoInsights[device.serialNumber].showAsType &&
            this.wemoInsights[device.serialNumber].showAsType === 'purifier'
          ) {
            instance = 'simulation/purifier-insight'
          } else {
            instance = 'insight'
          }
          break
        ...
        case 'urn:Belkin:device:outdoor:1': {
          ...
          if (instance === 'purifier') {
            instance = 'simulation/purifier'
          }
          break
        }
