...
module.exports = class deviceDimmer {
  ...
  async internalSwitchUpdate (value, callback) {
    ...
    try {
      ...
      if (!value) return
      try {
        const data = await this.client.sendRequest('urn:Belkin:service:basicevent:1', 'GetBinaryState', null)
  ...
  async internalBrightnessUpdate (value, callback) {
    ...
    try {
      ...
      await this.client.sendRequest('urn:Belkin:service:basicevent:1', 'SetBinaryState', {
