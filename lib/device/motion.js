...
module.exports = class deviceMotion {
  constructor (platform, accessory, device) {
    ...
    // Setup custom variables for this device type
    this.noMotionTimer = platform.wemoMotions[device.serialNumber] &&
      platform.wemoMotions[device.serialNumber].noMotionTimer
      ? platform.wemoMotions[device.serialNumber].noMotionTimer
      : platform.consts.noMotionTimer
