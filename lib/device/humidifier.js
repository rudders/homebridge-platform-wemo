...
module.exports = class deviceHumidifier {
  ...
  async getDeviceStatus () {
    try {
      ...
      if (this.debug) {
        this.log(
          '[%s] received update [FanMode: %s], [CurrentHumidity: %s], [DesiredHumidity: %s].',
          this.accessory.displayName,
          attributes.FanMode,
          attributes.CurrentHumidity,
          attributes.DesiredHumidity
        )
      }
  ...
  async internalTargetHumidityUpdate (value, callback) {
    ...
    try {
      ...
      await this.setDeviceStatus({ DesiredHumidity: this.hToWemoFormat[newValue] })
  ...
  async internalModeUpdate (value, callback) {
    ...
    try {
      ...
      await this.setDeviceStatus({ FanMode: newValue.toString() })
