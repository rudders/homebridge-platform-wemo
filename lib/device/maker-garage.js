...
module.exports = class deviceMakerGarage {
  constructor (platform, accessory, device) {
    ...
    this.getAttributes()
    this.client.on('attributeList', attribute => {
      this.externalDoorUpdate(attribute.name, attribute.value)
    })
  }
  ...
  async internalDoorUpdate (value, callback) {
    ...
    try {
      ...
      await this.client.sendRequest('urn:Belkin:service:basicevent:1', 'SetBinaryState', { BinaryState: 1 })
