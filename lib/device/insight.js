...
module.exports = class deviceInsight {
  constructor (platform, accessory, device) {
    ...
    this.inUseThreshold = platform.wemoInsights[device.serialNumber] && platform.wemoInsights[device.serialNumber].inUseThreshold
    this.inUseThreshold = isNaN(this.inUseThreshold) || this.inUseThreshold < 0
      ? this.helpers.defaults.inUseThreshold
      : this.inUseThreshold
  ...
  externalInsightUpdate (value, power, data) {
    ...
    this.externalOutletInUseUpdate(power > this.inUsePowerThreshold)
