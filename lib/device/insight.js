...
module.exports = class deviceStandard {
  constructor (platform, accessory, device) {
    ...
    this.client.on('binaryState', value => this.externalSwitchUpdate(value))
    this.client.on('insightParams', (state, power, data) => this.externalInsightUpdate(state, power, data))
  }
