...
module.exports = class deviceStandard {
  constructor (platform, accessory, device) {
    ...
    this.client.on('insightParams', (state, power, data) => this.externalInsightUpdate(parseFloat(power), data))
  }
  ...
  externalConsumptionUpdate (power) {
    ...
    const value = consumption > this.inUseThreshold
    try {
      const service = this.accessory.getService(this.Service.Outlet)
