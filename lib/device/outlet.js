...
module.exports = class deviceOutlet {
  constructor (platform, accessory, device) {
    ...
    this.service = this.accessory.getService(this.Service.Outlet) || this.accessory.addService(this.Service.Outlet)
  ...
  externalUpdate (value) {
    try {
      const outletState = this.service.getCharacteristic(this.Characteristic.On).value
