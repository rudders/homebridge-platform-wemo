...
module.exports = class deviceLink {
  constructor (platform, accessory, link, device) {
    ...
    if (this.api.version === 2.7 && this.api.versionGreaterOrEqual('1.3.0-beta.24')) {
      // adaptive lighting
      /* @TODO
        check if instance exists from before using instanceof
      */
  ...
  externalColourUpdate (value) {
    try {
      ...
      if (temperature !== value) {
        ...
        /* @TODO
          check for any difference in ct and disable AdaptiveLighting
          temperature could have been changed by user on the wemo app
